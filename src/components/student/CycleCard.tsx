...
const MODALITY_STYLE: Record<Modality, string> = {
  ...
  'Hipertrofia':   'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300',
  'Treino':        'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300',
  'Flexibilidade': 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300',
  'Corrida':       'bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300',
  'Handstands':    'bg-pink-100 text-pink-700 dark:bg-pink-900/40 dark:text-pink-300',
