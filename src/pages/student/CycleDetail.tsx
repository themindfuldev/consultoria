...
import { CalendarDays, MessageSquare, PlusCircle, Video } from 'lucide-react';
...
export function CycleDetail() {
  ...
  const handleCreate = async () => {
    ...
    if (!tabName.trim()) { setCreateError('Informe o dia/treino.'); return; }
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border-2 border-dashed border-slate-200 px-4 py-12 text-center dark:border-slate-700">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Grave seus treinos e compartilhe com seu treinador.
          </p>
        </div>
      ) : (
